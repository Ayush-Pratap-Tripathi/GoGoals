        ...
        >
          ...
          <div className="mt-6 text-center text-sm text-gray-300">
            <p>
              ...
              <button type="button" onClick={switchToSignup} className="text-yellow-400 font-semibold hover:underline cursor-pointer hover:text-yellow-300 transition-colors">
                Sign up
              </button>
            </p>
          </div>
